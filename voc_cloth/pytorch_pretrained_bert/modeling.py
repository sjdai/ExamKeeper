...
class BertForCloth(PreTrainedBertModel):
    ...
    def forward(self, inp, tgt):
        ...
        option -> bsz X opnum X num_candidates X olen
        output: bsz X opnum 
        '''
        # pdb.set_trace()###################
        ...
        out = out.expand(bsz, opnum, num_candidates, self.vocab_size)
        ...
        #################move to main.py##################
        return out, bsz, opnum, num_candidates
